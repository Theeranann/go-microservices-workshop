...
import (
	...
	"log"
	"os"
	"user_service/internal/delivery/servers"
	"user_service/pkg/configs"
	database "user_service/pkg/databases"
...
func main() {
	...
	consumer, err := sarama.NewConsumerGroup([]string{kafkaBroker}, "group_id_service_user", nil)
	if err != nil {
		panic(err)
	}
